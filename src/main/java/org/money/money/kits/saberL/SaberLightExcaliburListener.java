...
public final class SaberLightExcaliburListener implements Listener {
    ...
    public SaberLightExcaliburListener(Plugin plugin) {
        ...
        this.KEY_EXCALIBUR = new NamespacedKey(plugin, "saberlight_excalibur");
        this.KEY_SOULS     = new NamespacedKey(plugin, "saberlight_excalibur_souls");
    ...
    public void onDefenderBlock(EntityDamageByEntityEvent e) {
        ...
        if (!isSaberLight(defender)) return;
    ...
    private void addSoul(Player attacker, String reason) {
        ...
        attacker.sendActionBar(Component.text("§6Excalibur Soul +1 §7(" + souls + ") §8[" + reason + "]"));
    }
    ...
    public void onJoin(PlayerJoinEvent e) {
        ...
        if (!isSaberLight(p)) return; // only SaberLight uses this UI/system state by default
